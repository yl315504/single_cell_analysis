...
dir.create(paste0(out_dir,"Integrated_data_figures/"))
# Plot PCA
png(paste0(out_dir,"Integrated_data_figures/",out_prefix,"_PCAPlot.png"), width = 12, height = 12, units = 'in', res = 300)    
...
# Plot UMAP
png(paste0(out_dir,"Integrated_data_figures/", out_prefix, "_DimPlot_bycondition.png"), width = 12, height = 12, units = 'in', res = 300)
DimPlot(seurat_integrated)
dev.off()

pdf(paste0(out_dir,"Integrated_data_figures/",out_prefix,"_DimPlot_bysample.pdf"), width = 20, height = 16)
DimPlot(seurat_integrated, split.by = "sample")
dev.off()		
		
		
# Explore heatmap of PCs
png(paste0(out_dir,"Integrated_data_figures/",out_prefix,"_DimHeatmap_PCA.png"), width = 12, height = 12, units = 'in', res = 300)                           
...
# Plot the elbow plot
png(paste0(out_dir,"Integrated_data_figures/",out_prefix,"_ElbowPlot.png"), width = 12, height = 12, units = 'in', res = 300)                           
...
tmp <- paste(out_dir,"Integrated_data_figures/",out_prefix,"_integrated_cl_clustree.png",sep="")
...
# Plot the UMAP
png(paste0(out_dir,"Integrated_data_figures/",out_prefix,"_integrated_snn_res.0.8.png"), width = 12, height = 12, units = 'in', res = 300)                           
DimPlot(seurat_integrated,
        reduction = "umap",
        label = TRUE,
        label.size = 6)
...
# Plot the UMAP
png(paste0(out_dir,"Integrated_data_figures/",out_prefix,"_integrated_snn_res.0.4.png"), width = 12, height = 12, units = 'in', res = 300)                           
DimPlot(seurat_integrated,
        reduction = "umap",
        label = TRUE,
        label.size = 6)
...
saveRDS(seurat_integrated, paste0(out_dir,"/",out_prefix,"_integrated_seurat.rds"))
